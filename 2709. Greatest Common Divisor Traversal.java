...
class Solution {
    public boolean canTraverseAllPairs(int[] nums) {
        ...
        // If all nodes are part of the same component, components count will be 1.
